...
const Cart = () => {
    const {products, currency, cartItems, removeFromCart, getCartCount,
        ...
        const [slectedAddress, setSElectAddress] = useState(null)
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        className='outline-none'>
                                            ...
                                            cartItems[product._id] : 9).fill('').map
                                            ((_, index) => (
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{slectedAddress ? `${slectedAddress.street}, ${slectedAddress.city}, ${slectedAddress.state}, ${slectedAddress.country}` :
                            "No address found"}</p>
                        ...
                        {showAddress && (
                            ...
                            { addresses.map((address, index) =>(<p onClick={() => { setSElectAddress(address);
