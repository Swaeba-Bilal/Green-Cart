  ...
  return (
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            ...
            max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-tight'> Freshness You Can Trust, Savings You will Love! </h1>
        ...
        <div className='flex items-center mt-6 font-medium'>
            ...
            <img className='md:hidden transition group-focus:translate-x-1' src={
                assets.white_arrow_icon} alt="arrow" />
            </Link>

            <Link to={"/products"}className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
            Explore deals 
            <img className='transition group-hover:translate-x-1' src={
                assets.black_arrow_icon} alt="arrow" />
            </Link>
            </div>
        </div>
    </div>
