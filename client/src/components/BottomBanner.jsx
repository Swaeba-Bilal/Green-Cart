            ...
            <div>
                ...
                {features.map((feature, index) =>(
                    <div key={index} className='flex items-center gap-4 mt-2'>
                        <img src={feature.icon} alt={feature.title} className='w-9 md:w-11 shrink-0'/>
                        <div><h3 className='text-lg md:text-xl font-semibold md:w-60 shrink-0'>{feature.title}</h3>
